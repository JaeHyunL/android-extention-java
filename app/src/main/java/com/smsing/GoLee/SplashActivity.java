...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* GlideDrawableImageViewTarget ImageView 변수설정 */
    ...
    private void startLoading() {
        ...
        /**
         * Handler가필요한주요이유:
         * 작업스레드에서는 메인스레드의 변수를 참조하거나 변경할 수는 있지만,
         * 메인스레 드에서 정의된 UI(예: 위젯, View 등)을 변경할 수는 없다.
         * 작업스레드에서메인스레드의UI를변경할필요가 있을경우,
         * 작업스레드는 Handler를 통해 메인스레드에게 UI를 변경하라고 알릴 수 있다.
         */
